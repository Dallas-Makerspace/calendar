<div class="events add">
    ...
    <?php else: ?>
            ...
            <div class="row">
                ...
                <div class="col-sm-6">
                    <?= $this->Form->input('long_description', [
                        'help' => 'Plaintext only. Line spacing is preserved when displaying this information on the event page and links are automatically turned into hyperlinks. <strong>Taking payments through Eventbrite?</strong> Include details in the event description. The Eventbrite link will also be included on the event page.',
                        'label' => 'Description',
                        'required' => true,
                        'rows' => 12
                    ]) ?>
        ...
        <fieldset data-depends-on-field="categories-ids-1" data-hidden-on-field="categories-ids-2">
            ...
            <div class="alert alert-info">
                <ul>
                    ...
                    <li>If a person (you or the event Instructor, if set) will be receiving honorarium then tax information is required to be on file. If tax information is not on file and the fields are not completed for this submission then the submission won't be accepted. Tax information is transmitted securely over an encrypted connection with the server.</li>
                    <li>If honorarium will only be paid out to a committee then tax information is not required.</li>
                    <li>Don't want to enter tax information? You can mail it in instead, but won't be able to submit an event for honorarium until it has been received and processed.<br/>Mail W-9s to:<br/>Dallas Makerspace (W-9)<br/>P.O. Box 810663<br/>Dallas, TX 75381-0663</li>
            ...
            <div class="row" data-depends-on-field="request-honorarium" data-dependent-required="0">
                ...
                <div class="col-sm-4">
                    <?= $this->Form->input('contact.address1', [
                        'label' => 'Address 1',
                        'required' => false
                    ]); ?>
                    <?= $this->Form->input('contact.address2', [
                        'label' => 'Address 2',
                        'required' => false
                    ]); ?>
                    <?= $this->Form->input('contact.city', [
                        'label' => 'City',
                        'required' => false
                    ]); ?>
                    <?= $this->Form->input('contact.state', [
                        'label' => 'State',
                        'required' => false
                    ]); ?>
                    <?= $this->Form->input('contact.zip', [
                        'label' => 'Zip',
                        'required' => false
                    ]); ?>
                    <?= $this->Form->input('contact.taxid', [
                        'label' => 'SSN or Tax ID',
                        'required' => false
                    ]); ?>
                </div>
        ...
        <?= $this->Form->button(__('Submit Event'), ['class' => 'btn btn-lg btn-success']) ?>
        <?= $this->Form->end() ?>
